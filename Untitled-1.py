...
#nombre_asociado = "jesse pinkman"
#numero_asociado = 399058
#print(f"estimado/a {nombre_asociado},numero_asociado es:{numero_asociado}")
...
# Recuerda que la precisión de tu respuesta (espacios, ortografía y puntuación), es muy importante para llegar al resultado correcto #puntos_nuevos = 350
# puntos_totales = 1225
#puntos_nuevos = 350
#puntos_totales = 1225
#print(f"has ganado {puntos_nuevos} puntos¡En total,has acumulado {puntos_totales} puntos")
...
#puntos_nuevos = 350
#puntos_totales = 1225
#print(f"has ganado {puntos_nuevos}puntos¡En total acumulas{puntos_nuevos + puntos_totales} puntos")
